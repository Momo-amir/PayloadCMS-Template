...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."_locales" AS ENUM('da', 'en');
  ...
  CREATE TYPE "public"."bg" AS ENUM('', 'dark', 'accent', 'accentThree', 'secondary', 'neutral');
  CREATE TYPE "public"."enum_pages_blocks_card_block_cards_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_card_block_card_background_color" AS ENUM('', 'dark', 'accent', 'accentThree', 'secondary', 'neutral');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_card_block_card_background_color" AS ENUM('', 'dark', 'accent', 'accentThree', 'secondary', 'neutral');
  CREATE TYPE "public"."enum__pages_v_blocks_people_archive_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_published_locale" AS ENUM('da', 'en');
  CREATE TYPE "public"."enum__pages_v_version_hero_type" AS ENUM('none', 'highImpact', 'mediumImpact', 'lowImpact');
  CREATE TYPE "public"."enum__pages_v_version_hero_theme" AS ENUM('light', 'dark');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_published_locale" AS ENUM('da', 'en');
  ...
  CREATE TYPE "public"."enum_footer_social_links_platform" AS ENUM('facebook', 'twitter', 'instagram', 'linkedin', 'youtube', 'github', 'tiktok');
  CREATE TYPE "public"."enum_footer_theme_mode" AS ENUM('light', 'dark');
  ...
  CREATE TABLE "pages_blocks_two_block" (
  	...
  	"theme_mode" "enum_pages_blocks_two_block_theme_mode" DEFAULT 'light',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_card_block" (
  	...
  	"id" varchar PRIMARY KEY NOT NULL,
  	"heading" varchar,
  	"card_background_color" "enum_pages_blocks_card_block_card_background_color",
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_locales" (
  	...
  	"hero_theme" "enum_pages_hero_theme" DEFAULT 'dark',
  	"hero_centered" boolean DEFAULT 'false',
  ...
  CREATE TABLE "_pages_v_blocks_two_block" (
  	...
  	"theme_mode" "enum__pages_v_blocks_two_block_theme_mode" DEFAULT 'light',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_card_block" (
  	...
  	"id" serial PRIMARY KEY NOT NULL,
  	"heading" varchar,
  	"card_background_color" "enum__pages_v_blocks_card_block_card_background_color",
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_locales" (
  	...
  	"version_hero_theme" "enum__pages_v_version_hero_theme" DEFAULT 'dark',
  	"version_hero_centered" boolean DEFAULT 'false',
  ...
  CREATE TABLE "footer" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"theme_mode" "enum_footer_theme_mode" DEFAULT 'dark',
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  ALTER TABLE "pages_blocks_card_block_cards" ADD CONSTRAINT "pages_blocks_card_block_cards_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_card_block_cards" ADD CONSTRAINT "_pages_v_blocks_card_block_cards_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_card_block_cards_media_idx" ON "pages_blocks_card_block_cards" USING btree ("media_id");
  ...
  CREATE INDEX "_pages_v_blocks_card_block_cards_media_idx" ON "_pages_v_blocks_card_block_cards" USING btree ("media_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_footer_theme_mode";`)
}
