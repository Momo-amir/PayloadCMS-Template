...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_card_block_card_background_color" AS ENUM('', 'light', 'dark', 'primary', 'secondary');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_card_block_card_background_color" AS ENUM('', 'light', 'dark', 'primary', 'secondary');
  ...
  CREATE TABLE "pages_blocks_card_carousel_block_cards" (
  	...
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum_pages_blocks_card_carousel_block_cards_link_appearance" DEFAULT 'default',
  	"media_id" integer
  );
  ...
  CREATE TABLE "pages_blocks_card_carousel_block" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"color_mode" "enum_pages_blocks_card_carousel_block_color_mode" DEFAULT 'block',
  	"card_background_color" "bg" DEFAULT '',
  	"heading" varchar,
  	"description" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_card_carousel_block_cards" (
  	...
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum__pages_v_blocks_card_carousel_block_cards_link_appearance" DEFAULT 'default',
  	"media_id" integer,
  	"_uuid" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_card_carousel_block" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"color_mode" "enum__pages_v_blocks_card_carousel_block_color_mode" DEFAULT 'block',
  	"card_background_color" "bg" DEFAULT '',
  	"heading" varchar,
  	"description" varchar,
  	"columns" numeric DEFAULT 3,
