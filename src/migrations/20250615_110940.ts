...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_content" (
  	...
  	"id" varchar PRIMARY KEY NOT NULL,
  	"rich_text" jsonb,
  	"use_columns" boolean DEFAULT false,
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_two_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_two_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_two_block_order_idx" ON "pages_blocks_two_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_two_block_parent_id_idx" ON "pages_blocks_two_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_two_block_path_idx" ON "pages_blocks_two_block" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_two_block_order_idx" ON "_pages_v_blocks_two_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_two_block_parent_id_idx" ON "_pages_v_blocks_two_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_two_block_path_idx" ON "_pages_v_blocks_two_block" USING btree ("_path");
