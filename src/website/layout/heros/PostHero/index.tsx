import { formatDateTime } from '@/cms/utilities/formatDateTime'
...
export const PostHero: React.FC<{
  ...
  return (
    <TrackImpression
      ...
      componentType="hero"
      className="relative -mt-[9.4rem] flex items-end"
    >
      ...
      <div className="min-h-[80vh] select-none">
        ...
        <div className="absolute pointer-events-none left-0 top-0 w-full h-1/5 bg-linear-to-b opacity-55 from-black to-transparent -z-10" />
      </div>
    </TrackImpression>
  )
}
