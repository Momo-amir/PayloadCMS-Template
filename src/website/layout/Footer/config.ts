  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Light blue', value: 'bg-accent text-secondary light-mode' },
        { label: 'Light purple', value: 'bg-accent2 text-tertiary light-mode' },
        { label: 'Orange', value: 'bg-accent3 text-highlight2 light-mode' },
      ],
    },
  ],
  hooks: {
